CREATE TABLE "feed_follows" (
	...
	CONSTRAINT "feed_follows_user_id_user_id_unique" UNIQUE("user_id","user_id")
);
...
ALTER TABLE "feed_follows" ADD CONSTRAINT "feed_follows_user_id_feeds_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."feeds"("id") ON DELETE cascade ON UPDATE no action;